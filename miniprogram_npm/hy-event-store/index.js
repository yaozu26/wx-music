...
__DEFINE__(1677756937699, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1677756937700,"./event-store":1677756937701}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677756937700, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1677756937701, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1677756937700,"./utils":1677756937702}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677756937702, function(require, module, exports) {
...
return __REQUIRE__(1677756937699);
})()
